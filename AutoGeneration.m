...
h = controller(X, Xref, k_vec, theta_r_dot, J_m, dt); % Xref(4) = theta_r is the desired trajectory
...
grad_f_X_fcn = Function('grad_f_X_fcn',{X, dt, u, J_m, T_Fm, N, T_l, omega_m, J_l, T_Fl},{grad_f_X});
grad_f_u_fcn = Function('grad_h_u_fcn',{X, dt, u, J_m, T_Fm, N, T_l, omega_m, J_l, T_Fl},{grad_f_u});
